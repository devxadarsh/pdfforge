import { IconStyleType, ShapeCategory, ShapeDefinition } from '../models/pdf.models';
import { adjustColor, hexToRgba } from '../utilities/color.util';

export interface IconStyleOption {
  readonly id: IconStyleType;
...
export const ICON_STYLE_OPTIONS: IconStyleOption[] = [
  { id: 'outlined', label: 'Outlined', icon: 'fa-regular fa-square', description: 'Clean outline badge' },
  { id: 'filled', label: 'Filled', icon: 'fa-solid fa-square', description: 'Solid badge with contrasting icon' },
  { id: 'filled-outline', label: 'Filled Outline', icon: 'fa-regular fa-square-check', description: 'Solid fill with colored border' },
  { id: 'duotone', label: 'Duotone', icon: 'fa-solid fa-circle-half-stroke', description: 'Two-tone translucent depth' },
  { id: '3d', label: '3D', icon: 'fa-solid fa-cube', description: 'Tactile 3D elevated bevel & shadow' },
];

export function getIconBoxStyles(
  style: IconStyleType = 'outlined',
  ...
  switch (style) {
    ...
    case 'filled-outline':
      return {
        ...
        'align-items': 'center',
        'justify-content': 'center',
        background: fillColor && fillColor !== 'transparent' ? fillColor : hexToRgba(strokeColor, 0.16),
        'border-radius': '10px',
    ...
    case 'duotone':
      return {
        ...
        'align-items': 'center',
        'justify-content': 'center',
        background: hexToRgba(strokeColor, 0.16),
        'border-radius': '10px',
        border: `1.5px solid ${hexToRgba(strokeColor, 0.38)}`,
        'box-sizing': 'border-box',
      };
    case '3d': {
      const topColor = adjustColor(strokeColor, 28);
      const bottomColor = adjustColor(strokeColor, -18);
      return {
        width: '100%',
        height: '100%',
        display: 'flex',
        'align-items': 'center',
        'justify-content': 'center',
        background: `linear-gradient(145deg, ${topColor}, ${bottomColor})`,
        'border-radius': '12px',
        'box-shadow': '0 4px 10px rgba(0,0,0,0.28), inset 0 1px 1.5px rgba(255,255,255,0.45), inset 0 -2px 4px rgba(0,0,0,0.32)',
        border: `1px solid ${adjustColor(strokeColor, 35)}`,
        'box-sizing': 'border-box',
      };
    }
    case 'outlined':
...
export function getIconGlyphStyles(
  style: IconStyleType = 'outlined',
  strokeColor: string = '#2563eb',
  fontSize: number = 24
): Record<string, string> {
...
export const SHAPE_CATEGORIES: ShapeCategoryInfo[] = [
  ...
  { id: 'symbols', label: 'Geometric Symbols', icon: 'fa-solid fa-star', count: 12 },
];

export const ICON_CATEGORIES: ShapeCategoryInfo[] = [
...
export const ICON_DEFINITIONS: ShapeDefinition[] = [
  // =========================================================================
  // 1. UI & Wireframe Elements (16)
  // =========================================================================
  ...
  // =========================================================================
  // 3. Symbols & Decorative (All 20 symbols)
  // =========================================================================
  { id: 'symbol-star', label: '5-Point Star', category: 'symbols', icon: 'fa-solid fa-star', defaultWidth: 110, defaultHeight: 110 },
  { id: 'symbol-star-4', label: '4-Point Star', category: 'symbols', icon: 'fa-solid fa-star-of-life', defaultWidth: 110, defaultHeight: 110 },
  { id: 'symbol-star-6', label: '6-Point Star', category: 'symbols', icon: 'fa-solid fa-star-of-david', defaultWidth: 110, defaultHeight: 110 },
...
export const ALL_SHAPE_DEFINITIONS: ShapeDefinition[] = ICON_DEFINITIONS;
